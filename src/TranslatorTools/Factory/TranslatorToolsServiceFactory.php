...
class ServiceFactory implements \Zend\ServiceManager\FactoryInterface{
	...
	public function createService(\Zend\ServiceManager\ServiceLocatorInterface $oServiceLocator){
		...
		if(!isset($aConfiguration['asset_bundle']))throw new \UnexpectedValueException('TranslatorTools configuration is undefined');
		...
		return new \TranslatorTools\Service\Service($aConfiguration['asset_bundle']);
	}
}